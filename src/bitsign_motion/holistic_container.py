...
def _inspect_image(
    ...
    *,
    ...
    if architecture != "arm64" or operating_system != "linux":
        raise HolisticContainerError("Holistic image must be linux/arm64")
    ...
    expected_labels = {
        "org.opencontainers.image.base.digest": EXPECTED_BASE_IMAGE_DIGEST,
...
def build_holistic_container_image(
    *,
    ...
    """Build the pinned ARM64 worker and resolve the resulting immutable local image ID."""
...
def resolve_holistic_container_image(
    image_reference: str = DEFAULT_IMAGE_TAG,
    *,
    docker_executable: str = "docker",
...
def _validate_receipt_contract(
    ...
    *,
    ...
    if (
        ...
        or container["platform"] != "linux/arm64"
