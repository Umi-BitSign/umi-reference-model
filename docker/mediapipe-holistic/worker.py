...
def _probe_media(video: MountedInput, clip: ClipBounds) -> MediaInfo:
...
def _arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--clip-start-us", required=True)
    parser.add_argument("--clip-end-us", required=True)
...
def main() -> int:
    ...
    try:
        ...
        try:
            ...
            media = _probe_media(video, arguments.clip)
            selection = _select_frames(media, arguments.clip)
            ...
            arrays, displayed_hashes, mediapipe_version = _extract_landmarks(
                model, media, selection, arguments.clip, raw_rgb_path
            )
    ...
    completion = {
        ...
        "clip_start_us": arguments.clip.start_us,
        "clip_end_us": arguments.clip.end_us,
        "input_mirrored": arguments.input_mirrored_bool,
